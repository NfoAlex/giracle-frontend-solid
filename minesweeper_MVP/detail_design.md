...
- 起動トリガーは「チャット画面左上サービス名の右の絵文字」とする。
...
| 現在状態 | イベント | 次状態 | 備考 |
| --- | --- | --- | --- |
| Popup Closed | 絵文字クリック | Popup Open | 既存ゲーム状態を表示 |
| Popup Open | 絵文字クリック | Popup Closed | ゲーム状態保持 |
